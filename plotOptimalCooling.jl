...
# coupling_params, sim_params, search_params, N_values, [1,2,3,5,6,8], e₀)
# CoolingTNS.plotOptimal_energy_error_and_overlap_vs_N_pe_range(ham_name, coupling_params, sim_params, search_params, N_values, [1,2,3], e₀)
