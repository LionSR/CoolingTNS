...
CoolingTNS.plotOptimize_energy_error_and_overlap_vs_N(ham_name, coupling_params, sim_params, search_params, N_values, e₀)

# Uncomment the following lines to plot for multiple pe values
# pe_values = [0, 1, 3, 4, 5, 6, 9]
# CoolingTNS.plotOptimize_energy_error_and_overlap_vs_N_pe_range(ham_name, coupling_params, sim_params, search_params, N_values, pe_values, e₀)
