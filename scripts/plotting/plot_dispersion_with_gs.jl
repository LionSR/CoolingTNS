...
function plot_dispersion_with_ground_state(N::Int, J::Real, h::Real, bc::Symbol;
    ...
    n_k_ref = compute_bdg_reference_occupation(k_sorted, J, h)
    ...
    ax2.plot(k_sorted / pi, n_k_ref, "g--", linewidth=2,
    ...
    ax1.set_title("Energy Dispersion and BdG Raw Fourier Reference\n(N=$N, J=$J, h=$h, BC=$bc)", fontsize=16)
