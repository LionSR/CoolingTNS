...
@testset "TN note large-N cooling qualifications" begin
    ...
    @test occursin("`(N, method, evolution method, R, Dmax, trajectory index)` tuple", plan_flat)
    ...
    @test occursin("each `(N, method, evolution method, R, Dmax, trajectory index)` tuple", driver_flat)
