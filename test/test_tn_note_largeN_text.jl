...
@testset "TN note large-N cooling qualifications" begin
    ...
    @test occursin("includes the evolution time `te`, mode-measurement suffixes, and suffixes for non-default detuning schedules and randomized evolution times", evidence_flat)
