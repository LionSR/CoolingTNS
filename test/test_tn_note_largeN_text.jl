...
@testset "TN note large-N cooling qualifications" begin
    ...
    @test occursin("| 10 | 128 | 8/12 | -1.25614747 | -1.32463289 | 121 | >=128 | >=128 |", evidence_flat)
    ...
    @test occursin("| 1 | 128 | 8/12 | -1.21970618 | -1.32463289 | 116 | >=128 | >=128 |", evidence_flat)
    @test occursin("| 2 | 128 | 7/12 | -1.24703609 | -1.32463289 | 108 | >=128 | >=128 |", evidence_flat)
    @test occursin("| 5 | 128 | 8/12 | -1.25381271 | -1.32463289 | 106 | >=128 | >=128 |", evidence_flat)
