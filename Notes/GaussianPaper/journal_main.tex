...
\begin{equation}
    \frac{1}{N}\sum_{k=0}^{N/2} \left|\tr\left(\eta_k h_k \left[\mathcal{E}_k^n(\rho_k)- \sigma_k\right]\right)\right|\le 2 \frac{\sum_{k=0}^{N/2} \eta_k e^{-\alpha_k n}}{N} \le e^{- \alpha n},
\end{equation}
